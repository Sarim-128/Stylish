    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.body}>
                <Image style={styles.image} source={require('../../assets/images/Onboardings/banner3.png')} />

                <Text style={styles.title}>Choose Products</Text>
                <Text style={styles.subtitle}>Get your order delivered fast, safely packaged, and tracked live to your doorstep.</Text>
            </View>
